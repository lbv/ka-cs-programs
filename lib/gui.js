 ...
 * GUI
 *
 * Simple mechanism for adding Graphical User Interface
 * components to the canvas.
 */
var GUI = function() {
	this.widgets  = [];
	this.rTree    = [];
	...
	this.txtl = new TextLayer();
	this.txtl.setFillStyle('#000000');
};
...
GUI.prototype.draw = function() {
	...
	for (var i = 0; i < this.widgets.length; ++i) {
		...
		if (widget.font !== null) {
			this.txtl.setFont(widget.font); }

		pushMatrix();
		this.txtl.save();

		translate(widget.x, widget.y);
		this.txtl.translate(widget.x, widget.y);
		if (widget.scale !== 1.0) {
 ...
 * GUILabel
 *
 * A label of text to display simple messages.
 */
var GUILabel = function(text, font) {
	GUIWidget.call(this);
...
GUILabel.__super__             = GUIWidget.prototype;
GUILabel.prototype             = new GUIWidget();
GUILabel.prototype.constructor = GUILabel;

GUILabel.prototype.draw = function() {
	this.gui.txtl.fill(this.text, 0, 0);
};

/**
 * GUIScale
 *
 * A slider widget for selecting a numeric form a given
 * range.
 */
var GUIScale = function(lo, hi, step, cb) {
	GUIWidget.call(this);
...
GUIScale.__super__             = GUIWidget.prototype;
GUIScale.prototype             = new GUIWidget();
GUIScale.prototype.constructor = GUIScale;


GUIScale.prototype.anchor = function() {
	GUIScale.__super__.anchor.apply(this, arguments);
...
GUIScale.prototype.calcLabelWidths = function() {
	var txtl = this.gui.txtl;
	txtl.setFont(this.font);

	this.label1W = txtl.measure(this.label1);
	this.label2W = txtl.measure(this.label2);
};
 ...
 * A horizontal scale.
 */
var GUIHScale = function(lo, hi, step, cb) {
	GUIScale.apply(this, arguments);
...
GUIHScale.__super__             = GUIScale.prototype;
GUIHScale.prototype             = new GUIScale();
GUIHScale.prototype.constructor = GUIHScale;

GUIHScale.prototype.setValue = function(val) {
	GUIHScale.__super__.setValue.apply(this, arguments);
...
GUIHScale.prototype.draw = function() {
	...
	this.gui.txtl.fill(this.label1, 0, 14);
	this.gui.txtl.fill(this.label2, 110 - this.label2W, 14);
};
